 ...
 * This is useful for multi-tenant applications where each tenant may have its own schema.
 *
 ...
 * @property username The unique username, which can be null or blank for an anonymous actor.
